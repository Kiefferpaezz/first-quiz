...
ALTER TABLE animals ADD COLUMN favorite_food_id serial;
ALTER TABLE people ADD COLUMN favorite_food_id serial;
...
SELECT p.name AS pet_name, ff.name
FROM animals AS p
JOIN favorite_foods AS ff ON p.favorite_food_id = ff.food_id
